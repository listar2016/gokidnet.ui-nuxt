<template>
  <div class="ds-day-picker">
    <div class="ds-week-header mb-2">
      <div class="subtitle py-1 pl-2 ds-light-forecolor">{{ summary }}</div>

      <v-tooltip bottom>
        <v-btn slot="activator" small icon depressed @click="prev" class="ds-light-forecolor ma-0">
      ...
      <v-tooltip bottom>
        <v-btn slot="activator" small icon depressed class="ds-light-forecolor ma-0" @click="next">
...
export default {
  ...
  methods: {
    ...
    prev() {
      ...
      this.$emit("change", ev);
      EventBus.$emit("calendar-emit", ev.month.span.end.month);
      // console.log("prev", ev.month.span.end.month);
    },
    ...
    next() {
      ...
      // console.log(JSON.stringify(ev.month.span.end.month));
      ...
      this.$emit("change", ev);
      // console.log("next", ev.month.span.end.month);
      EventBus.$emit("calendar-emit", ev.month.span.end.month);
    },
